...
class HeatManager:
    ...
    def calculate_heat(self, slice_id: str, current_round: int = None) -> Dict:
        ...
        # 5. 记录日志
        self._log_change(slice_id, old_score, new_score, "自动温度计算", "system")
    ...
    def heat(self, slice_id: str, reason: str = "用户主动升温", changed_by: str = "user") -> Dict:
        """
        加热记忆（升温）
    ...
    def cool(self, slice_id: str, reason: str = "自然冷却", changed_by: str = "system") -> Dict:
        """
        冷却记忆（降温）
    ...
    def freeze(self, slice_id: str, reason: str, changed_by: str = "user") -> Dict:
        """
        冻结记忆（防止死灰复燃）
    ...
    def thaw(self, slice_id: str, reason: str = "用户解冻", changed_by: str = "user") -> Dict:
        """
        解冻记忆
    ...
    def detect_zombie_revival(self, slice_id: str, triggered_by: str) -> Dict:
        ...
        return {"is_zombie": False, "triggered_by": triggered_by}
    ...
    def _update_heat(self, slice_id: str, temp: str, score: int, current_round: int = None):
        """更新温度"""
        if current_round is not None:
            self.db.execute(
                """
    ...
    def _log_change(
        self, slice_id: str, old_score: int, new_score: int, reason: str, changed_by: str
    ):
        """记录温度变更日志"""
        self.db.execute(
            """
...
if __name__ == "__main__":
    ...
    # 创建温度管理器
    temp_mgr = HeatManager(
        db_path, {"TIME_DECAY_RATE": 0.1, "ROUND_DECAY_RATE": 5, "USER_HEAT_BONUS": 30}
    )
